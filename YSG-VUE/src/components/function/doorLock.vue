    ...
    <div class="search" style="height: 100%">
      ...
      <section class="g-flexview">
        ...
        <section class="g-scrollview">
          <img src="../../assets/images/fastkey/openDoor.png" width="100%" height="100%" @click="openDoor" v-show="!isOpen">
          <img src="../../assets/images/fastkey/opened.png" width="100%" height="100%" v-show="isOpen">
        </section>
      </section>
    </div>
  </div>
